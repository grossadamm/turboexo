...
## Loaded tune
`CurrentTune.msq` = **`TurboExo_idleleanout_2026-07-11.msq`**: reqFuel **7.1**,
...
`crankingEnrichTaper` 0.1 s, `CrankAng` 10°.
> Not yet burned/tested at time of writing — confirm reqFuel 7.1 in TunerStudio and burn.
...
4. Before trying to hold an idle: **raise `engineProtectMaxRPM`** from 1500
   (currently a fuel+spark cut right at the target rpm).
